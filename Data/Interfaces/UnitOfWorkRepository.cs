...
namespace Data.Interfaces
{
    ...
    {
        public static readonly string DB1 = @"Data SOURCE=.\SQLEXPRESS;Initial Catalog=AmkorK5_ElevatorService; User ID = sa;TrustServerCertificate=true; Password=acsserver;Connect Timeout=30;";
