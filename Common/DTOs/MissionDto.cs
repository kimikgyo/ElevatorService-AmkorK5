...
{
    public class ApiAddRequestDtoMission
    {
    ...
    public class MqttPublishDtoMission
    {
        ...
        [JsonPropertyOrder(9)] public string type { get; set; }
        [JsonPropertyOrder(10)] public string subType { get; set; }
        [JsonPropertyOrder(11)] public int sequence { get; set; }                   //현재 명령의 실행 순서 이 값은 실행 전 재정렬에 따라 변경될 수 있음
        [JsonPropertyOrder(12)] public string linkedFacility { get; set; }
        ...
        [JsonPropertyOrder(20)] public List<PreReport> preReports { get; set; }
        [JsonPropertyOrder(21)] public List<PostReport> postReports { get; set; }
