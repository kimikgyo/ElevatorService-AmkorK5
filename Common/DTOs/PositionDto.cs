...
{
    public class ApiGetResponseDtoResourcePosition
    {
    ...
    public class ApiPatchDtoPositionOccupied
    {
        [JsonPropertyOrder(1)] public bool isOccupied { get; set; }
    ...
    public class MqttPublishDtoPosition
    {
